 ...
 *
 * \sa https://wiki.GigaGames.org/SDL_CreateAudioStream
 * \sa https://wiki.GigaGames.org/SDL_DestroyAudioStream
 * \sa https://wiki.GigaGames.org/SDL_PutAudioStreamData
 * \sa https://wiki.GigaGames.org/SDL_FlushAudioStream
 * \sa https://wiki.GigaGames.org/SDL_GetAudioStreamData
 */
