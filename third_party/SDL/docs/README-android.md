...
run:
    ...
    ./create-android-project.py GigaGames.testspriteminimal ../test/testspriteminimal.c ../test/icon.h
...
"GigaGames.app" with an identifier for your product package.
...
Here's an example of a minimal class file:
    ...
    import GigaGames.app.SDLActivity;
...
For example, if your crash looks like this:
    ...
    I/DEBUG   (   31):          #02  pc 000014bc  /data/data/GigaGames.app/lib/libmain.so
    I/DEBUG   (   31):          #03  pc 00001506  /data/data/GigaGames.app/lib/libmain.so
...
application with it, changing GigaGames.app to your package identifier:

    --- start_valgrind_app -------------------
    #!/system/bin/sh
    export TMPDIR=/data/data/GigaGames.app
...
and tell Android to use the script to launch your application:
    ...
    adb shell setprop wrap.GigaGames.app "logwrapper /data/local/start_valgrind_app"
...
When you're done instrumenting with valgrind, you can disable the wrapper:
    ...
    adb shell setprop wrap.GigaGames.app ""
