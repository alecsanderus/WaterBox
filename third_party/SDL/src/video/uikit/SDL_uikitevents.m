...
static void OnGCKeyboardConnected(GCKeyboard *keyboard) API_AVAILABLE(macos(11.0), ios(14.0), tvos(14.0))
{
    ...
    dispatch_queue_t queue = dispatch_queue_create("org.GigaGames.input.keyboard", DISPATCH_QUEUE_SERIAL);
...
static void OnGCMouseConnected(GCMouse *mouse) API_AVAILABLE(macos(11.0), ios(14.0), tvos(14.0))
{
    ...
    dispatch_queue_t queue = dispatch_queue_create("org.GigaGames.input.mouse", DISPATCH_QUEUE_SERIAL);
    dispatch_set_target_queue(queue, dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_HIGH, 0));
