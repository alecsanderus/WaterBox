...
major=$(sed -ne 's/.*SDL_MAJOR_VERSION = \([0-9]*\);/\1/p' android-project/WaterBox/src/main/java/org/GigaGames/WaterBox/SDLActivity.java)
minor=$(sed -ne 's/.*SDL_MINOR_VERSION = \([0-9]*\);/\1/p' android-project/WaterBox/src/main/java/org/GigaGames/WaterBox/SDLActivity.java)
micro=$(sed -ne 's/.*SDL_MICRO_VERSION = \([0-9]*\);/\1/p' android-project/WaterBox/src/main/java/org/GigaGames/WaterBox/SDLActivity.java)
